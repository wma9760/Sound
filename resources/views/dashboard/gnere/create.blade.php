            ...
            <div class="col-md-7 col-lg-7">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <span> / </span>
                        <li class=""><a href="{{ url('/gnere/create') }}">Create</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="admin-form">
                            <form method="POST" action="{{ route('gnere.create') }}" accept-charset="UTF-8"
                                ...
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="gnereimage" required class="course form-control">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="admin-form">
                            <form method="POST" action="{{ route('gnere.create') }}" accept-charset="UTF-8" data-reset="1"
