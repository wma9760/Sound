    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-5 col-lg-5">
            <div class="widgetbar">
                ...
                <a href="{{url('/vedio/create')}}" class="btn btn-primary-rgba mr-2"><i class="fa-solid fa-file-plus"></i>Create vedio</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="card-title mb-0">All Vedioes</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 200px;">
                                                ...
                                                <a href="{{route('vedio.update',$vedio->id)}}">Update</a> |
