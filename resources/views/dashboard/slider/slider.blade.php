...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-5 col-lg-5">
            <div class="widgetbar">
                <a href="{{url('/slider/create')}}" class="btn btn-primary-rgba mr-2"><i class="fa-solid fa-file-plus"></i>Create slider</a>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form method="post" id="sliderDataForm">
                                <table id="datatable-buttons"
                                            ...
                                            <th>
                                                <div class="inline custom-checkbox">
                                                    <input id="checkboxAll" type="checkbox"
                                                        class="custom-control-input selectAllslider"
                                    ...
                                    <tbody>
                                        @foreach ($data as $slider)
                                            <tr>
                                                <td>{{ $count++ }}</td>
                                                <td> <img src="frontend/images/slider/{{ $slider->sliderimage }}" height="50px"
                                                        width="100px" alt=""> </td>
                                                <td>{{ $slider->title }}</td>
                                                @if ($slider->status==1)
                                                <td>Active</td>
                                            ...
                                            @endif
                                                ...
                                                <td style="width: 200px;">
                                                    ...
                                                    <a href="{{ route('slider.update', $slider->id) }}">Update</a> 
