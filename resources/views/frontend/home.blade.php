			...
			<section class="row">
				<div class="col-12">
					<div class="hero owl-carousel" id="hero">
						<div class="hero__slide" data-bg="{{url('new/img/home/slide1.jpg')}}">
						...
						<div class="hero__slide" data-bg="{{url('new/img/home/slide2.jpg')}}">
						...
						<div class="hero__slide" data-bg="{{url('new/img/home/slide3.jpg')}}">
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="/frontend/images/album/{{ $audioalbum->albumimage }}" alt="">
						...
						<div class="album__title">
							<h3><a href="release.html">{{ $audioalbum->name }}</a></h3>
							<span>Hello</span>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<ul class="main__list">
								<li class="single-item">
									...
									<a data-link data-title="Cinematic" data-artist="AudioPizza" data-img="img/covers/cover1.jpg" href="Tere-Isaq-Nachaya-By-Atif-Aslam-And-Abeeda-Parveen-live-version.mp3" class="single-item__cover">
			...
			<div class="row">
				<div class="col-12">
					<div class="partners owl-carousel">
						...
						<a href="#" class="partners__img">
							<img src="img/partners/themeforest-light-backgrounds.png" alt="">
						</a>
					</div>
				</div>
			</div>
