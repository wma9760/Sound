			...
			<div class="row">
				<div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
					<div class="footer__logo">
						<img src="{{url('new/img/logo.svg')}}" alt="">
					</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">© Volna, 2022. Created by <a href="#" target="_blank">Dmitry Volkov</a>.</small>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- JS -->
	<script src="{{url('new/js/jquery-3.5.1.min.js')}}"></script>
	<script src="{{url('new/js/bootstrap.bundle.min.js')}}"></script>
	<script src="{{url('new/js/owl.carousel.min.js')}}"></script>
	<script src="{{url('new/js/jquery.magnific-popup.min.js')}}"></script>
	<script src="{{url('new/js/smooth-scrollbar.js')}}"></script>
	<script src="{{url('new/js/select2.min.js')}}"></script>
	<script src="{{url('new/js/slider-radio.js')}}"></script>
	<script src="{{url('new/js/jquery.inputmask.min.js')}}"></script>
	<script src="{{url('new/js/plyr.min.js')}}"></script>
	<script src="{{url('new/js/main.js')}}"></script>
</body>

<!-- Mirrored from dmitryvolkov.me/demo/volna/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 May 2022 19:37:29 GMT -->
</html>
<!-- <a href="javascript:void(0);" class="gotop extr_top"></a>
<div class="ms_footer_wrapper fixed-bottom">
    <div class="ms_footer_logo">
        <a href="index.html"><img src="/frontend/images/sites/logo.png"  width="150px" alt=""></a>
    </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer_box">
                    ...
                    <p>The Miraculous – Online Music Store Script is packed with many features that allow you to play
                        music while browsing other pages.</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer_box footer_app">
                    ...
                    <a href="#" class="foo_app_btn"><img src="frontend/assets/images/google_play.jpg" alt=""
                            class="img-fluid"></a>
                    <a href="#" class="foo_app_btn"><img src="frontend/assets/images/app_store.jpg" alt=""
                            class="img-fluid"></a>
                    <a href="#" class="foo_app_btn"><img src="frontend/assets/images/windows.jpg" alt=""
                            class="img-fluid"></a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="footer_box footer_subscribe">
                    ...
                    <form id="newsLetter" method="post" action="https://miraculous.mediacity.co.in/newsletter"
                        data-reset="1">
                        <input type="hidden" name="_token" value="pSWr3YbCpDKzktwrgePB6tICuqiclWoKiNiblDSU">
                        <div class="form-group">
                            <input type="text" name="name" class="form-control require" placeholder="Enter Name">
                        </div>
                        <div class="form-group">
                            <input type="text" name="email" class="form-control require" data-valid="email"
                                data-error="Invalid email." placeholder="Enter Email">
                        </div>
                        <div class="form-group">
                            <input type="button" value="Sign Me Up" data-action="submitThisForm" class="ms_btn">
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <ul class="foo_con_info">
                        <li>
                            <div class="foo_con_icon">
                                <img src="frontend/assets/images/svg/phone.svg" alt="">
                            </div>
                        ...
                        <li>
                            <div class="foo_con_icon">
                                <img src="frontend/assets/images/svg/message.svg" alt="">
                            </div>
                            <div class="foo_con_data">
                                <span class="con-title">Email Us :</span>
                                <span>
                                    <a href="cdn-cgi/l/email-protection.html#6900070f062904001b080a1c05061c1a470a0604"><span
                                            class="__cf_email__"
                                            data-cfemail="8fe6e1e9e0cfe2e6fdeeecfae3e0fafca1ece0e2">[email&nbsp;protected]</span></a>
                                </span>
                            </div>
                        </li>
                        <li>
                            <div class="foo_con_icon">
                                <img src="frontend/assets/images/svg/add.svg" alt="">
                            </div>
                            <div class="foo_con_data">
    ...
    <div class="col-lg-12">
        <div class="ms_pages">
            <p><a href="faqs.html" target="_blank">Faqs</a></p>
            <p><a href="pages/eyJpdiI6ImtsNVN4QktQbkVBNng1d1B3WUsvaFE9PSIsInZhbHVlIjoiZG1SNTRiMmV6eWhGQ05zR2JrL010QT09IiwibWFjIjoiODYwNTFhZWYxYzA4OWEzZGJlOGU4NjU3NjU2Y2ZmZjhkODE2Njg2OTlhYWIzNT"
                    target="_blank">Iusto irure quaerat</a></p>
            <p><a href="pages/eyJpdiI6IlNEK3JkaVlwMHFzRm9JRzVkZHdEU3c9PSIsInZhbHVlIjoiODBnaWZvenpGU055Zm5LTXlOckVsQT09IiwibWFjIjoiZTY3N2ZjZjU5YzIwOGU4YjJlN2NmOGZiNGQ3NjI2M2Q5YTc5NDM4MDk4ODhmOT"
                    target="_blank">Iusto omnis in asper</a></p>
        </div>
    </div>
</div>
</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content add_lang">
                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        <form action="{{route('home.langauage')}}" method="POST" class="form-group">
                            @csrf
                            ...
                            <input type="submit" class="btn btn-dark mt-3" value="Add" >
                          </form>
                    </div>
                </div>
            </div>
...
<div id="loginModal" class="modal centered-modal" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog login_dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="userLogin" method="post" action="https://miraculous.mediacity.co.in/user/login" data-modal="1"
                    data-redirect="home.html">
                    <input type="hidden" name="_token" value="pSWr3YbCpDKzktwrgePB6tICuqiclWoKiNiblDSU">
                    <div class="ms_register_img">
                        <img src="frontend/assets/images/register_img.png" alt="" class="img-fluid">
                    </div>
                    <div class="ms_register_form">
                        <h2>login / Sign in</h2>
                        <div class="form-group">
                            <input type="text" placeholder="Enter Email" class="form-control required"
                                data-valid="email" data-error="Invalid email." name="email">
                            <span class="form_icon">
                                <i class="fa_icon form-envelope" aria-hidden="true"></i>
                            </span>
                        </div>
                        <div class="form-group">
                            <input type="password" placeholder="Enter Password" class="form-control require"
                                name="password">
                            <span class="form_icon">
                        ...
                        <div class="popup_forgot">
                            <a href="javascript:;" data-toggle="modal" data-target="#myModalForgot">Forgot Your
                                Password?</a>
                        </div>
                        <p>Don't Have An Account? <a href="#registerModal" data-toggle="modal"
...
<div id="myModalForgot" class="modal  centered-modal" role="dialog">
    <div class="modal-dialog login_dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="https://miraculous.mediacity.co.in/password/email" method="POST">
                    <input type="hidden" name="_token" value="pSWr3YbCpDKzktwrgePB6tICuqiclWoKiNiblDSU">
                    <div class="ms_register_img">
                        <img src="frontend/assets/images/register_img.png" alt="" class="img-fluid">
                    </div>
                    <div class="ms_register_form">
                        ...
                        <div class="form-group">
                            <input id="userForgotEmail" name="email" required="" type="text" placeholder="Enter Email"
                        ...
                        <p>Don't worry if you forgot your password. We will send you a new password to your registered
                            email Id.</p>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ms_share_img">
                        <img src="frontend/assets/images/svg/playlist.svg" class="img-fluid" alt="Playlist">
                    </div>
                    <div class="ms_share_text">
                        <h1>Create New Playlist</h1>
                        <input type="text" name="playlist_name" id="playlist_name" class="form-control"
                            placeholder="Playlist Name">
                        <div class="clr_modal_btn">
                            <a href="javascript:;" class="create_new_playlist">Create</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="ms_share_text">
                        ...
                        <div class="clr_modal_btn">
                            <a href="javascript:;" class="add_in_playlist ms_add_in_playlist">
                                Add To Playlist</a>
                            <button class="hst_loader"><i class="fa fa-circle-o-notch fa-spin"></i>Loading
                            </button>
                            <a href="javascript:;" class="create_playlist">Create Playlist</a>
                        </div>
                    </div>
                </div>
            </div>
...
{{-- <script type="text/javascript" src="{{ url('frontend/assets/plugins/nice_select/jquery.nice-select.min.js') }}"></script> --}}
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>
<script src="{{ url('frontend/assets/js/player/jquery.jplayer.min.js') }}"></script>
<script src="{{ url('frontend/assets/js/audio-player.js') }}"></script>
 <script src="{{ url('frontend/assets/js/bootstrap.min.js') }}"></script>
<script src="{{ url('frontend/assets/js/jquery.slimscroll.js') }}"></script>
<script src="{{ url('frontend/assets/js/card.js') }}"></script>
<script src="{{ url('frontend/assets/js/player/player.js') }}"></script>
<script src="{{ asset('js/app.js') }}" defer></script>
<script src="{{ url('frontend/assets/js/front/custom.js') }}"></script>
